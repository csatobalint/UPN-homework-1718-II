function [U_next_L, F_next_L, v_next_L, p_next_L, rho_next_L, T_next_L, ...
          U_next_R, F_next_R, v_next_R, p_next_R, rho_next_R, T_next_R] = ...
                    ClosedPipe_BC (U_prev, A, c_v, gamma, R, dx, dt)
...
%Updating the U_next & F_next matrices on the boundaries:
    U_next_L=zeros(3,1); U_next_R=zeros(3,1);
    ...
    F_next_L=zeros(3,1); F_next_R=zeros(3,1);
